...
#define DEBUG_SHARED_SET_READ_LEVEL_0 0
#define DEBUG_SHARED_SET_READ_LEVEL_1 0
#define DEBUG_SHARED_SET_READ_LEVEL_2 0
#define DEBUG_SHARED_SET_READ_LEVEL_3 0
#define DEBUG_SHARED_SET_READ_LEVEL_4 0
#define DEBUG_SHARED_SET_READ_LEVEL_TMP 1
                            ...
                            knd_set_elem_unmarshall_cb_t cb, struct kndTask *task)
{
    ...
    if (subdir_block_size) {
        err = read_subdirs(self, dir, fd, dir->global_offset + dir->payload_block_size,
                           subdir_block_size, idbuf, idbuf_size, cb, task);
...
static int read_elem(struct kndStorageLeaf *leaf, struct kndSharedSetDir *dir,
                     const char *id, size_t id_size, knd_set_elem_unmarshall_cb_t cb,
                     void *ctx, void **result, struct kndTask *task)
{
    struct kndOutput *file_out = task->file_out;
    struct kndSharedSetDir *subdir;
