                      ...
                      size_t *total_size)
{
    ...
    dir = (struct kndRelEntry*)self->rel_name_idx->get(self->rel_name_idx,
...
static gsl_err_t inst_entry_alloc(void *obj,
                                  ...
                                  void **item)
{
    struct kndRelEntry *parent_dir = obj;
                                   ...
                                   void *item)
{
    ...
    size_t buf_size;
    struct kndRelEntry *parent_dir = accu;
