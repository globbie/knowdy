...
static int export_facets_GSP(struct kndConcept *self, struct kndSet *set)
{
    struct glbOutput *out = self->out;
...
static int export_descendants_GSP(struct kndConcept *self)
{
    char buf[KND_NAME_SIZE];
    size_t buf_size;
    struct glbOutput *out = self->out;
